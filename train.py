...
x = tf.placeholder(tf.float32, (None, 28, 28, 1))  # Others
#x = tf.placeholder(tf.float32, (None, 32, 32, 1))  # LeNet-5
y = tf.placeholder(tf.int32, (None))
y_one_hot = tf.one_hot(y, 10)
out = model.LeNet1(x)  # choose network
